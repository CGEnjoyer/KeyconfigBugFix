...
def menu_add_draw_USERPREF_MT_save_load(self, context):
    ...
    if prefs.menu_save_keyconfig:
        self.layout.operator("wm.kbf_save_keyconfig", text="Save Keyconfig").keymaps_restore = False
    if prefs.menu_save_keyconfig_as:
        self.layout.operator("wm.kbf_save_keyconfig_as", text="Save Keyconfig As...")
    if prefs.menu_save_and_restore:
        self.layout.operator("wm.kbf_save_keyconfig", text="Save & Restore Keyconfig").keymaps_restore = True
